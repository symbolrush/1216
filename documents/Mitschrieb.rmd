...
<!-- \flushright \qed \flushleft -->

<!-- \subsection{BFS Suchbam mit einer Tiefe von k} -->
...
<!-- \begin{itemize} -->
<!-- \item Knoten können mehrmals angefasst werden. (Wegen Stack) -->
<!-- \item "Festnageln" des Knotens geschieht zu einem anderen Zeitpunkt. -->
<!-- \end{itemize} -->

<!-- rekursiv, Tiefensuche -->
<!-- \subsection{Algorithmus} -->
<!-- \begin{lstlisting} -->
<!-- def DFS(v): -->
<!-- 	global step -->
